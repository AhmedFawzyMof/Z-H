...
function checkForP() {
  return _checkForP.apply(this, arguments);
}
function _checkForP() {
  _checkForP = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
      var chekIfProductAvalabil, res, products, i, product_id, newCart, j;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1)
          switch ((_context.prev = _context.next)) {
            case 0:
              _context.next = 2;
              return fetch("/check/products", {
                method: "post",
                headers: new Headers({
            ...
            case 2:
              chekIfProductAvalabil = _context.sent;
              _context.next = 5;
              return chekIfProductAvalabil.json();
            case 5:
              res = _context.sent;
              products = res.isItAva;
