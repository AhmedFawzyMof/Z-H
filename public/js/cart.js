...
function calContainer() {
  ...
  if (cart.length) {
    ...
    _countContainer.innerHTML = "<img  id='emptyCart' src='/img/cart.png'/> <a id='goToShop' href='/'>\u0627\u0630\u0647\u0628 \u0644\u0644\u062A\u0633\u0648\u0642</a>";
  }
}
function cartItems() {
  var Container = document.getElementById("container");
  var mappedItems = cart.map(function (item, index) {
    return "\n          <div class=\"cart\" key=".concat(index, ">\n                <img src='").concat(item.image, "'>\n                <div class='info'>\n                 <a href=\"/product/show/").concat(item.id, "\" ><p>").concat(item.name.substr(0, 25), "</p></a>\n                  <p>").concat(item.price, " \u062C</p>\n                  <p>").concat(item.price * item.quantity, " \u062C</p>\n                </div>\n                <div class=\"quantity\">\n                  <button onclick=\"incQuantity(").concat(item.id, ", ").concat(item.quantity + 1, ")\" ><i class='bx bx-plus'></i></button>\n                  <p>").concat(item.quantity, "</p>\n                  <button onclick='dicQuantity(").concat(item.id, ")'><i class='bx bx-minus' ></i></button>\n                </div>\n                <button onclick='removeItemFormCart(").concat(item.id, ")' class='removeBtn'><i class='bx bxs-x-circle'></i></button>\n          </div>");
  }).join("");
